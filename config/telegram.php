...
return [
    ...
    */
    'bots'                         => [
        env('TELEGRAM_BOT_USERNAME_1', 'bot_1') => [
            'username'            => env('TELEGRAM_BOT_USERNAME_1', 'YOUR-BOT-USERNAME'),
            'token'               => env('TELEGRAM_BOT_TOKEN_1', 'YOUR-BOT-TOKEN'),
    ...
    |
    */
    'default'                      => env('TELEGRAM_BOT_USERNAME_1', 'bot_1'),
